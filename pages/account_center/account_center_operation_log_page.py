...
class AccountCenterOperationLogPage(BasePage):
    ...
    def add_data_to_search_massages(self, search_data):
        ...
        if search_data['type'] == '':
            self.driver.click_element(
                'x,/html/body/div[1]/div[4]/div/div/div[2]/div[2]/div[2]/div[1]/form/div[2]/span[1]/div/div/ul/li[1]')
        elif search_data['type'] == '1':
            self.driver.click_element(
        ...
        if search_data['status'] == '':
            self.driver.click_element(
                'x,/html/body/div[1]/div[4]/div/div/div[2]/div[2]/div[2]/div[1]/form/div[2]/span[2]/div/div/ul/li[1]')
