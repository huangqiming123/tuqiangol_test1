...
class GlobalComplexSearchPage(BasePage):
    ...
    def complex_search_result(self):
        ...
        try:
            # 获取用户关系
            self.driver.get_element("x,/html/body/div[13]/div/div/div[2]/div[4]/div[2]/div[2]/div[1]/div[2]/div[2]/table"
                                    "/tbody/tr[1]/td[7]/a[1]")
            result_num = 1
            return result_num
        # 当搜索结果大于1条时
            ...
            try:
                ...
                total = new_paging.get_total_number("x,//*[@id='complex_paging_device']","x,//*[@id='complex_device_tbody']")
                return total
            except:
                return 0
    ...
    def dev_install_info_edit(self,install_com,install_pers,install_addr,install_posi):
        # 将滚动条滚动至保存按钮处
        save_butt_ele = self.driver.get_element("x,/html/body/div[13]/div/div/div[2]/div[4]/div[2]/div[2]/div[2]/div/form/div[3]/div/button")
        self.driver.execute_script(save_butt_ele)

        # 输入安装公司
        self.driver.operate_input_element("x,//*[@id='device_info_b']/fieldset/fieldset/fieldset/div[2]/div[1]/input",install_com)
        # 输入安装人员
        self.driver.operate_input_element("x,//*[@id='device_info_b']/fieldset/fieldset/fieldset/div[3]/div/input",install_pers)
        # 输入安装地址
        self.driver.operate_input_element("x,//*[@id='device_info_b']/fieldset/fieldset/fieldset/div[1]/div[2]/input",install_addr)
        # 输入安装位置
        self.driver.operate_input_element("x,//*[@id='device_info_b']/fieldset/fieldset/fieldset/div[2]/div[2]/input",install_posi)
    ...
    def dev_info_save(self):
        self.driver.click_element("x,/html/body/div[13]/div/div/div[2]/div[4]/div[2]/div[2]/div[2]/div/form/div[3]/div/button")
        self.driver.wait(1)
