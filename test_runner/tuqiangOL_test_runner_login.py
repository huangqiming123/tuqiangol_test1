...
def send_mail(file_new):
    ...
    smtp.login("646642287@qq.com", "zhangao6466642287")
...
if __name__ == '__main__':
    ...
    test_dir_login = test_runner_path.test_cases_path('login')

    # 指定测试报告目录
    test_report_login = test_runner_path.test_report_path('login')
