...
if __name__ == '__main__':
    ...
    test_dir_account_center = test_runner_path.test_cases_path('set_up')

    # 指定测试报告目录
    test_report_account_center = test_runner_path.test_report_path('set_up')
    ...
    # 定义报告存放路径
    filename_account_center = test_report_account_center + '\\' + now + 'set_up_result.html'
