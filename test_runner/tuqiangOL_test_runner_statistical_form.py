...
if __name__ == '__main__':
    ...
    test_dir_account_center = test_runner_path.test_cases_path('statistical_form')

    # 指定测试报告目录
    test_report_account_center = test_runner_path.test_report_path('statistical_form')
