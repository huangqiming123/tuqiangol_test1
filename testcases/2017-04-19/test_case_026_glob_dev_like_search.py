...
class TestCase026GlobDevLikeSearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_global_dev_like_search(self):
        '''通过csv测试全局搜索-搜索栏设备模糊查找功能'''
        ...
        for row in csv_data:
            ...
            for row in user_relation:
                ...
                dev_search01_sql = "select id from assets_device where userId in " + str(
                    lower_account_tuple) + "and deviceName like '" + dev_search["dev_name"] + "%'" + ";"
                ...
                dev_search02_sql = "select id  from assets_device where userId in " + str(
                    lower_account_tuple) + "and imei like '" + dev_search["dev_imei"] + "%';"
