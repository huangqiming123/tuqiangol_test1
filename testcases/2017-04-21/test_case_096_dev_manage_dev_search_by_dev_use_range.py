...
class TestCase096DevManageDevSearchByDevUseRange(unittest.TestCase):
    def setUp(self):
    ...
    def test_dev_manage_dev_search_by_dev_use_range(self):
        '''测试设备管理-设备搜索-by 设备使用范围'''
        ...
        for row in csv_data:
            ...
            # 执行sql脚本，通过当前登录账号userId查找该用户下设备使用范围符合搜索条件的所有设备记录
