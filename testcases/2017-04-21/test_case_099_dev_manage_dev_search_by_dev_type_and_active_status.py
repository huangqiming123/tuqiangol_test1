    ...
    def test_dev_manage_dev_search_by_dev_type_and_expired(self):
        ...
        for row in csv_data:
            ...
            for row in user_relation:
                ...
                get_login_user_dev_sql = "select a.id from assets_device a where a.userId in " + str(
                    lower_account_tuple) + " and a.mcType = '" + \
                ...
                print("当前登录账户jimitest下机型名称为" + search_info["login_user_dev_type"] + "的未激活设备共：" + str(
                    login_user_dev_count) + "条!")
