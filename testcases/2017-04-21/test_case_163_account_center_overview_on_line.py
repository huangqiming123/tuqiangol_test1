...
class TestCase163AccountCenterOverviewOnline(unittest.TestCase):
    def setUp(self):
    ...
    def test_account_center_overview_online(self):
        # 打开途强在线首页-登录页
        ...
        # 点击库存
        self.account_center_page_details.account_overview('在线')
