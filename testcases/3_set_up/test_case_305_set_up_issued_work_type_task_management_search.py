...
class TestCase305SetUpIssuedWorkTypetTaskManagementSearch(unittest.TestCase):
    # 测试 设置 - 指令管理 - 下发工作模式任务管理搜索功能
    driver = None
    base_url = None
    base_page = None
    log_in_page = None
    ...
    def test_case_set_up_issued_work_type_task_management_search(self):
        # 断言url
