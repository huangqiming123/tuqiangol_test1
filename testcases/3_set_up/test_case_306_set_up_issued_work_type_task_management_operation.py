...
class TestCase306SetUpIssuedWorkTaskManagementOperation(unittest.TestCase):
    # 测试 设置 - 指令管理 - 下发工作模式任务管理 - 查看设备
    driver = None
    base_url = None
    base_page = None
    log_in_page = None
    ...
    def test_case_set_up_issued_work_type_task_management_operation(self):
        # 断言url
