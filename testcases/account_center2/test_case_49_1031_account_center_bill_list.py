...
class TestCase49AccountCenterBillList(unittest.TestCase):
    ...
    def test_case_account_center_bill_list(self):
        ...
        for row in csv_data:
            ...
            self.account_center_page.add_data_to_search_bill_list_in_bill_list_page(search_data)

            ## 获取数据库查询的条数
            sql_number = self.account_center_page.get_sql_number_after_click_search_button(account, search_data)
            # 获取页面上的条数
