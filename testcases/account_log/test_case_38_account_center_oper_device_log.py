...
class TestCase38AccountCenterOperDeviceLog(unittest.TestCase):
    ...
    def test_account_center_oper_device_log(self):
        ...
        for row in csv_data:
            ...
            self.help_page.search_equipment_manager_log(search_data)
            ...
            for row1 in user_relation:
                ...
                get_total_sql = self.help_page_sql.equipment_manager_search_sql(lower_account_tuple, search_data)
                print(get_total_sql)
                ...
                web_total = self.help_page.get_current_business_log()
