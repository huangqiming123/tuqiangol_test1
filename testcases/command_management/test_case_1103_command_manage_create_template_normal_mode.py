...
class TestCase1103CommandManageCreateTemplateNormalMode(unittest.TestCase):
    driver = None
    base_url = None
    base_page = None
    log_in_page = None
    ...
    def test_case_1103_command_manage_create_template_normal_mode(self):
        # 断言url
        ...
        self.assertEqual('该项不能为空', get_text_wake_up_time_fail)
        ...
        self.assertEqual('该项不能为空', get_text_fail_limit_cycle)

        # 大于15
        self.command_management_page.add_limit_cycle_in_create_templates('91')
        self.command_management_page.click_ensure()
        get_text_fail_limit_cycle = self.command_management_page.get_text_fail_limit_cycles()
        self.assertEqual('该项不能大于90', get_text_fail_limit_cycle)

        # 非正整数
        self.command_management_page.add_limit_cycle_in_create_templates('刷刷刷')
        self.command_management_page.click_ensure()
        get_text_fail_limit_cycle = self.command_management_page.get_text_fail_limit_cycles()
        self.assertEqual('该项只能填写正整数', get_text_fail_limit_cycle)
        ...
        self.assertEqual('该项不能大于90该项只能填写正整数', get_text_fail_limit_cycle + get_texts_fail_limit_cycle)
