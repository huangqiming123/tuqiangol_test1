...
class TestCase125WorkTypeTemplateManagementOperation(unittest.TestCase):
    ...
    def test_case_125_work_type_template_management_operation(self):
        ...
        self.assertEqual(expect_text_after_click_delete, self.command_management_page.actual_text_after_click_delete())
        # 点击关闭
        self.command_management_page.ensure_work_template_operation_delete()
        # 断言
        expect_title_text_after_click_work_type_template_management = '工作模式模板管理'
        self.assertEqual(expect_title_text_after_click_work_type_template_management,
                         self.command_management_page.actual_title_text_after_click_work_type_template_management())'''
        ...
        # 点击下发指令
        self.command_management_page.click_issued_command()
        # 断言
        expect_title_text_after_click_issued_command = '执行指令'
        self.assertEqual(expect_title_text_after_click_issued_command,
                         self.command_management_page.actual_title_text_after_click_issued_command())
        # 点击关闭
        self.command_management_page.close_issued_command()
        # 断言
        expect_title_text_after_click_work_type_template_management = '工作模式模板管理'
        self.assertEqual(expect_title_text_after_click_work_type_template_management,
                         self.command_management_page.actual_title_text_after_click_work_type_template_management())

        csv_file = self.command_management_page_read_csv.read_csv('issued_command_data.csv')
        ...
        for row in csv_data:
            ...
            self.assertEqual(expect_title_text_after_click_issued_command,
                             self.command_management_page.actual_title_text_after_click_issued_command())
            self.command_management_page.add_data_to_issued_command(issued_command_data)
