...
class TestCase128IssuedWorkTaskManagementOperation(unittest.TestCase):
    ...
    def test_case_128_issued_work_type_task_management_operation(self):
        ...
        expect_title_text_after_click_look_equipment='下发工作模式'
        self.assertEqual(expect_title_text_after_click_look_equipment,self.command_management_page.actual_text_click_look_equipment())
