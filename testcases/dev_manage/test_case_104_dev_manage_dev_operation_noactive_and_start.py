...
class TestCase104DevManageDevOperationNOActiveAndStart(unittest.TestCase):
    def setUp(self):
    ...
    def test_dev_manage_dev_operation_noactive_and_start(self):
        ...
        # 选择已激活和开机的设备
        self.dev_manage_page.choose_dev_noactive_and_statr()
