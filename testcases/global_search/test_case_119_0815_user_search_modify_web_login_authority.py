...
class TestCase119UserSearchModifyWebLoginAuthority(unittest.TestCase):
    def setUp(self):
    ...
    def test_case_user_search_modify_web_login_authority(self):
        # 打开途强在线首页-登录页
