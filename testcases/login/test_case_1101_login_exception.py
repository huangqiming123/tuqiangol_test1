...
class TestCase1101LoginException(unittest.TestCase):
    ...
    def test_case_101_login_exception(self):
        ...
        self.assertEqual('用户名或密码不能为空', self.login_page.get_exception_text())
        ...
        self.login_page.login_button_click()
        sleep(2)
        self.assertEqual('账号不存在', self.login_page.get_exception_text())
        ...
        self.login_page.login_button_click()
        sleep(2)
        self.assertEqual('密码错误', self.login_page.get_exception_text())
