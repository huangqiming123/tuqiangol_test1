...
class TestCase1102SportStatisticalTracelFormExceptionSearch(unittest.TestCase):
    ...
    def test_mileage_form_exception_search(self):
        ...
        # 填写下级的imei搜索
        sleep(2)
        self.statistical_form_page2.input_imei_to_search_in_mileage_form(self.statistical_form_page2.get_imei())
        # 断言
        # 获取查询设备的imei
        ...
        # 获取搜索的数量
        get_number_after_search = self.statistical_form_page.get_number_after_search_in_tracel_form()
        self.assertEqual(0, get_number_after_search)

        get_text_after_search = self.statistical_form_page.get_text_after_search_in_tracel_form()
