...
class TestCase2104SportStatisticalPakingNotShutDownOperation(unittest.TestCase):
    def setUp(self):
        # 前置条件
        # 实例化对象
    ...
    def test_case_2104_sport_statistical_parking_not_shut_down_operation(self):
        # 断言url
        ...
        for n in range(5):
            ...
            if number == 0:
                ...
                for m in range(number):
                    ...
                    # 获取每个组设备的数量
                    dev_number = self.statistical_form_page.get_dev_number_in_stay_not_shut_down(m)
                    # 点开每一个分组
                    self.statistical_form_page.click_per_group_in_stay_not_shut_down(m)
                    dev_number_list = self.statistical_form_page.get_dev_number_list_in_stay_not_shut_down(m)
