...
class TestCase2105SportStatisticalAccFormOperation(unittest.TestCase):
    def setUp(self):
        # 前置条件
        # 实例化对象
    ...
    def test_case_2105_sport_statistical_acc_form_operation(self):
        # 断言url
        ...
        for n in range(5):
            ...
            if number == 0:
                ...
                for m in range(number):
                    ...
                    # 获取每个组设备的数量
                    dev_number = self.statistical_form_page.get_dev_number_in_acc_form(m)
                    # 点开每一个分组
                    self.statistical_form_page.click_per_group_in_acc_form(m)
                    dev_number_list = self.statistical_form_page.get_dev_number_list_in_acc_form(m)
