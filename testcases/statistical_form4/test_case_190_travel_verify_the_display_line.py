...
class TestCase190TravelVerifyTheDisplayLine(unittest.TestCase):
    def setUp(self):
        # 前置条件
        # 实例化对象
    ...
    def test_case_190_travel_verify_the_display_line(self):
        # 断言url
        ...
        for n in range(display_line_number):
            ...
            display_line_name = self.form_page.get_per_display_name_travel(n)
            # 点击
