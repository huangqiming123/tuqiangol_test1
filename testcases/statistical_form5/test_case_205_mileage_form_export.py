...
class TestCase205MileageExport(unittest.TestCase):
    # 里程报表
    def setUp(self):
        # 前置条件
        # 实例化对象
    ...
    def test_case_205_mileage_form_export(self):
        # 断言url
        ...
        if total_page == 0:
            ...
            if total_page == 1:
                ...
                for a in range(total_number_per_page):
                    web_data.append(self.form_export_page.get_per_line_data_mileage(a))
