...
class TestCase215AlarmOverviewFormExport(unittest.TestCase):
    # 告警总览 - 导出
    def setUp(self):
        # 前置条件
        # 实例化对象
    ...
    def test_case_215_alarm_overview_form_export(self):
        # 断言url
        ...
        # 搜索数据
        self.form_export_page.search_alarm_overview_data()
        ...
        total_number_per_page = self.statistical_form_page4.get_total_number_per_page_in_alarm_overview()
        if 0 == total_number_per_page:
            pass
        else:
            for a in range(total_number_per_page):
                web_data.append(self.form_export_page.get_per_line_data_alarm_overview(a))
